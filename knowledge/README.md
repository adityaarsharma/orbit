...
| File | What it is |
|---|---|
| [`bug-signatures.md`](bug-signatures.md) | 40+ WordPress bug signatures (security · core-compat · WooCommerce · i18n · perf/DB · PHP 8) — pattern → detection hint → edge cases. Sourced from Patchstack/WPScan/WP-core/PHP-manual 2025–26. |
